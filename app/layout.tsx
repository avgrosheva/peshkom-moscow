...
import { PanelTop, Map as MapIcon, Footprints, Heart } from "lucide-react";
...
export default function RootLayout({
  ...
  return (
    <html lang="ru">
      ...
      <body
        className={`${unbounded.variable} ${inter.variable} h-[100dvh] max-h-[100dvh] w-screen bg-background text-light-black overflow-x-hidden ${unbounded.className}`}
      >
            ...
            >
              <PointsContext.Provider value={{ points, setPoints }}>
                <div className="flex justify-center w-full h-full">
                  ...
                  {/* нижняя навигация */}
                  {pathname.includes("/auth") || pathname.includes("/map") ? null : (
                    <nav
